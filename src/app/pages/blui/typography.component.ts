    ...
    template: `
        <div style="padding: 16px">
            <table id="type-table">
                ...
                <tr>
                    <td>Display 4</td>
                    <td><span class="mat-headline-1">Test</span></td>
                    <td><span class="blui-headline-1">Test</span></td>
                    <td>Headline 1</td>
                </tr>
                <tr>
                    <td>Display 3</td>
                    <td><span class="mat-headline-2">Test</span></td>
                    <td><span class="blui-headline-2">Test</span></td>
                    <td>Headline 2</td>
                </tr>
                <tr>
                    <td>Display 2</td>
                    <td><span class="mat-headline-3">Test</span></td>
                    <td><span class="blui-headline-3">Test</span></td>
                    <td>Headline 3</td>
                </tr>
                <tr>
                    <td>Display 1</td>
                    <td><span class="mat-headline-4">Test</span></td>
                ...
                <tr>
                    <td>Headline</td>
                    <td><span class="mat-headline-5">Test</span></td>
                    <td><span class="blui-headline-5">Test</span></td>
                    <td>Headline 5</td>
                </tr>
                <tr>
                    <td>Title</td>
                    <td><span class="mat-headline-6">Test</span></td>
                    <td><span class="blui-headline-6">Test</span></td>
                    <td>Headline 6</td>
                </tr>
                <tr>
                    <td>Subheading 2</td>
                    <td><span class="mat-subtitle-1">Test</span></td>
                ...
                <tr>
                    <td>Body 2</td>
                    <td><span class="mat-subtitle-2">Test</span></td>
